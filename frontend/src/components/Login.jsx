...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (errorMessage === "Invalid email") {
        ...
        errorMessage.includes("Please verify your email before logging in")
      ) {
  ...
  return (
    <>
      ...
      >
        Welcome Back to DailyDrafts
      </p>
      <div className="flex flex- items-center  justify-center mt-8">
        <div className="bg-gray-100 h-[350px] w-[260px] sm:h-[350px] sm:w-[400px] md:h-[500px] md:w-[500px] rounded-md shadow-md flex flex-col items-center justify-center">
          <form
          ...
          >
            ...
            <button
              type="submit"
              className="bg-blue-500 text-white text-xl p-3 rounded-md w-50 sm:w-80 md:w-80 font-bold "
            >
              Sign in
            </button>
          </form>
